     ...
     <div class="row">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              ...
              echo '    
              <h6 class="m-0 font-weight-bold text-primary">Admin Profile  <a href="update.php?id='. $row['id'] .'" title="Update Record" data-toggle="tooltip"> 
              ...
              <div class="row">
              <div class="col-lg-6">
              <h6 style="color:#4e73df!important;font-weight:bold;">Name</h6>

                      '.$row["first_name"].'    '.$row["last_name"].'<br>
                </div> 
                <div class="col-lg-6"> 
                      <h6 style="color:#4e73df!important;font-weight:bold;">Email</h6>
